          ...
          : active && variant == "tab"
            ...
            : !active && variant == "tab"
              ...
              : active && variant == "default"
                ...
                "bg-foreground/10 backdrop-blur-lg text-xs text-foreground/80 rounded-lg px-2 py-1.5 hover:bg-foreground/15 transition-colors hover:ring-1 ring-foreground/25"
      }`}
    >
      {children}
    </div>
